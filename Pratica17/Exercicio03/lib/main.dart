...
class CarrosselState extends State<Carrossel> {
  ...
  List<Map> imagens = [
    {
      'arquivo': 'img/batman_logo.png',
      'titulo': 'Batman',
      'descricao': 'Batman, Liga da Justiça'
    },
    {
      'arquivo': 'img/flash_logo.png',
      'titulo': 'Flash',
      'descricao': 'Flash, Liga da Justiça'
    },
    {
      'arquivo': 'img/superman_logo.png',
      'titulo': 'Superman',
      'descricao': 'Superman, Liga da Justiça'
    },
    {
      'arquivo': 'img/mulherMaravilha_logo.png',
      'titulo': 'Mulher Maravilha',
      'descricao': 'Mulher Maravilha, Liga da Justiça'
    },
  ];
  void anterior() =>
